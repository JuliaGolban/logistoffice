...
if (widthWindow < 500) {
  ...
  canvas.to("#canva4-2", { x: -25 * speed, y: -3.4 * speed, scale: -1 }, 0);
  canvas.to("#canva4-2-1", { x: -25 * speed, y: -3.4 * speed, scale: -1 }, 0);
  canvas.to("#canva4-2-2", { x: -25 * speed, y: -3.4 * speed, scale: -1 }, 0);
  canvas.to("#canva4-2-3", { x: -25 * speed, y: -3.4 * speed, scale: -1 }, 0);
