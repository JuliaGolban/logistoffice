...
canvas.to(
  "#canva3-2",
  { x: 10 * speed, y: 10 * speed, scale: 0.1, opacity: 0 },
  0
);
canvas.to("#canva4", { x: -10 * speed, y: 0 * speed, scale: 0.1 }, 0);
canvas.to("#canva5-1", { x: 1 * speed, y: -1 * speed, scale: 0.7 }, 0);
canvas.to("#canva5-2", { x: -1 * speed, y: -1 * speed, scale: 0.7 }, 0);
canvas.to("#canva6", { delay: 0.03, scale: 0.7 }, 0);
canvas.to(
  "#canva7",
  { y: 0.3 * speed, delay: 0.03, scale: 1, height: "800px" },
  0
);
